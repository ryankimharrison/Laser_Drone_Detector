...
class Console:
    ...
    def do_level(self, a):
        ...
        # At-rest |a| for the impact check below. MEASURED, because this part
        # reads 0.89-0.99 g stationary rather than a textbook 1.000, and a
        # threshold against 1.0 spends most of its budget on that scale error.
        base_g = 1.0
        acc = 0.0
        for _ in range(16):
            g = d.accel_g()
