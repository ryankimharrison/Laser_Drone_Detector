...
MICROSTEP_DIVISOR = 16                  # runtime profile; saved legacy J is 1/16
DYNAMIC_MICROSTEPPING = False           # opt-in --dynamic-microstep
...
MAX_MOTOR_RATE = 1000   # 2026-09-20 21:15 run_210030: at 1434-1600 steps/s DR lost ~21 deg in 8 s vs gravity; clean 0.96 delivery was only ever measured at <=969; bench pending
...
WIDE_MAX_MOTOR_RATE = 1000   # 2026-09-20 21:15 same evidence as MAX_MOTOR_RATE; bench pending
...
FEEDFORWARD_GAIN = 0.5   # 2026-09-20 ramp step 1 RE-RUN: on run_203933 flow rows had lag 0.27 s (baseline 0.49-0.58) but 47% of rows had no flow (coherence guard was a speed gate, fixed by FLOW_COHERENCE_FRAC); score per ff_source tier per gyro-rate bin; no improvement -> 0.0
